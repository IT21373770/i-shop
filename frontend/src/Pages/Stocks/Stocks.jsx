            ...
            <table className="stk-table"  >
              ...
              <tbody>
                {items.filter((val) => {
                  ...
                  <tr id={items.Product_Id} hidden>
                    <td colSpan={6}>
                      <center><StockData id={items.Product_Id}/></center><br/>
                    <label onClick={()=>close(items.Product_Id)} ><BsArrowUpCircle fontSize={20}/></label>
                    </td>
                  </tr>
                  </> 
                ))}
